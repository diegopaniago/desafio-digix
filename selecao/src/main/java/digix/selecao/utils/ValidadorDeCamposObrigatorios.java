...
public class ValidadorDeCamposObrigatorios {
    ...
    public ValidadorDeCamposObrigatorios valorEhNegativo(Integer valor, String mensagemDeErro) {
    ...
    public ValidadorDeCamposObrigatorios listaEhVazia(List objects, String mensagemDeErro) {
